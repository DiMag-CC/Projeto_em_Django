...
class MainView(View):
    def get(self, request):
        lista_ultimas_questoes = Pergunta.objects.order_by("-data_criacao") # Ordena as questões da mais antiga para a mais recente
        contexto = {'perguntas' : lista_ultimas_questoes}
        return render(request, 'forum/index.html', contexto) # Renderiza a "request" do usuário na página 'forum/index.html' de acordo com o CONTEXTO dado a criação da MainView
